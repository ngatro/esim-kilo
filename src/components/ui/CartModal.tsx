              ...
              {items.map((item) => (
                <div key={item.id} className="flex items-center justify-between bg-slate-900/50 rounded-xl p-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-white font-medium w-16 text-right">${item.price * item.quantity}</p>
          ...
          <div className="p-6 border-t border-slate-700 space-y-4">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 bg-sky-500 text-white rounded-lg hover:bg-sky-400 font-semibold"
              >
                Checkout
              </button>
            </div>

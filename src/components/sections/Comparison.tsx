      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn>
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">{t("comparison.title")}</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <FadeIn delay={0}>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-6">{t("comparison.owsim")}</h3>
          ...
          <FadeIn delay={0.1}>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-6">{t("comparison.roaming")}</h3>
              <ul className="space-y-4">
                {[
          ...
          <FadeIn delay={0.2}>
            <motion.div 
              ...
              whileHover={{ y: -5 }}
            >
              <h3 className="text-xl font-bold text-white mb-6">{t("comparison.local")}</h3>
              <ul className="space-y-4">
                {[

...
export async function PATCH(request: Request) {
  try {
    ...
    const { id, isPopular, isBestSeller, isHot, isActive, priority, badge, priceUsd, priceRaw, retailPriceUsd, retailPriceRaw, supportTopUp, supportTopUpType } = body;
    ...
    if (supportTopUpType !== undefined) updateData.supportTopUpType = supportTopUpType;

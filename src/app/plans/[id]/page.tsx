...
import { ESIM_PLANS, getPlanById, formatData } from "@/lib/esim-data";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2">
              <div className="sticky top-24 bg-slate-800/70 border border-slate-700/60 rounded-3xl p-7 shadow-2xl">
                ...
                <button className="w-full border border-slate-600 hover:border-slate-500 text-slate-300 hover:text-white font-medium py-3 rounded-xl text-sm transition-colors">
                  Add to Wishlist
                </button>

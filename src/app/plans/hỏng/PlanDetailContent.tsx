          ...
          <div className="flex flex-col">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center gap-2 text-base">
                <span className="font-medium text-slate-600">{t("planDetail.excellent")}</span>
                <span className="text-slate-700">{t("planDetail.outOf5")}</span>
                <span className="text-green-600">★ {t("planDetail.trustpilot")}</span>
              </div>
            </div>
            ...
            <div className="mb-6 space-y-2">
              ...
              {locations.length > 0 && (
                <div className="flex items-center gap-2 text-sm text-slate-600 mt-2 pt-2 border-t border-slate-100">
                  <span>🌍</span>
                  <span>{t("planDetail.coverage")}: {locations.slice(0, 3).join(", ")}{locations.length > 3 ? ` +${locations.length - 3} more` : ""}</span>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-10">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-6">
                <h2 className="text-xl font-bold text-slate-800 mb-4">{t("planDetail.planSpecifications")}</h2>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {plan.unusedValidTime > 0 && (
                    <div className="bg-slate-50 rounded-xl p-4">
                      <p className="text-xs text-slate-500 mb-1">{t("planDetail.validAfterPurchase")}</p>

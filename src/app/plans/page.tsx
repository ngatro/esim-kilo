        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 sm:py-20">
              ...
              <p className="text-slate-400 text-sm mb-6">Try adjusting your filters or sync plans from eSIM Access</p>
              <div className="flex gap-3 justify-center">
                <button onClick={clearFilters} className="bg-slate-700 hover:bg-slate-600 text-white px-5 py-2.5 rounded-xl text-sm transition-colors">Clear Filters</button>
                <button onClick={syncPlans} disabled={syncing}
                  className="bg-sky-500 hover:bg-sky-400 disabled:bg-slate-600 text-white font-semibold px-5 py-2.5 rounded-xl text-sm transition-colors">
